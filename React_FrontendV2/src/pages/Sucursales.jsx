		...
		>
			...
			>
				...
				<section className="col-4 p-4" style={{ textAlign: "left" }}>
					<h3 className="mb-3" style={{ color: "#4c9ae7" }}>
						<b>Encuentra tu sucursal</b>
					</h3>
					<article className="mb-4 text-body-secondary">
						<b>Localiza tu sucursal más cercana</b>
					</article>
					<article>
						<p className="card-text mb-4" style={{ color: "#727272" }}>
							Introduce tu localidad o, simplemente tu código postal, y
							comprueba las sucursales cerca de tí.
						</p>
					</article>
					<article>
						<input
						...
						<p style={{ color: "red" }} hidden={search.trim() !== ""}>
							Haz clic en el botón, para listar todos los resultados.
						</p>
					</article>
					<article>
						<p className="card-text mb-4">
							<img
								...
								alt="Ubicación"
							/>
							<span style={{ borderBottom: "0.1em solid #6297b7" }}>
			...
			<article
				...
				className="row roundedshadow-sm"
			>
				<div className="col-2" />
				<section className="col-5 p-4" style={{ textAlign: "left" }}>
					<h4 className="mb-3" style={{ color: "#4c9ae7", width: "80%" }}>
						<b>
							{amountResults > 1
								? `Se han encontrado ${amountResults} sucursales cerca de tu ubicación actual`
								: `Se ha encontrado 1 sucursal cerca de tu ubicación actual`}
						</b>
					</h4>
					<div
					...
					>
						<b style={{ fontSize: "0.8em" }}>{search}</b>
					</div>
					<div>
						{afterSearch.map((store) => (
							<article key={store.id}>
								{store.Estado === "ACTIVO" &&
									store.Empresa.includes("HR") &&
									store.Condición === "Tienda" && (
										<a
											href="#"
										...
										>
											...
											>
												...
												<article style={{ width: "20em" }} className="col">
													...
													<div
														style={{ fontSize: "0.9em", color: "#4c9ae7" }}
														className="mb-1"
													>
														{store.Teléfono}
													</div>
